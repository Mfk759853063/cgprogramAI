...
def generate_mask(x):
        name_mask_pic = cv2.UMat(cv2.imread('labourer/idcardLib/name_mask.jpg'))
        sex_mask_pic = cv2.UMat(cv2.imread('labourer/idcardLib/sex_mask.jpg'))
        nation_mask_pic = cv2.UMat(cv2.imread('labourer/idcardLib/nation_mask.jpg'))
        birth_mask_pic = cv2.UMat(cv2.imread('labourer/idcardLib/birth_mask.jpg'))
        year_mask_pic = cv2.UMat(cv2.imread('labourer/idcardLib/year_mask.jpg'))
        month_mask_pic = cv2.UMat(cv2.imread('labourer/idcardLib/month_mask.jpg'))
        day_mask_pic = cv2.UMat(cv2.imread('labourer/idcardLib/day_mask.jpg'))
        address_mask_pic = cv2.UMat(cv2.imread('labourer/idcardLib/address_mask.jpg'))
        idnum_mask_pic = cv2.UMat(cv2.imread('labourer/idcardLib/idnum_mask.jpg'))
        ...
        cv2.imwrite('labourer/idcardLib/name_mask_%s.jpg'%pixel_x, name_mask_pic)
        cv2.imwrite('labourer/idcardLib/sex_mask_%s.jpg' %pixel_x, sex_mask_pic)
        cv2.imwrite('labourer/idcardLib/nation_mask_%s.jpg' %pixel_x, nation_mask_pic)
        cv2.imwrite('labourer/idcardLib/birth_mask_%s.jpg' %pixel_x, birth_mask_pic)
        cv2.imwrite('labourer/idcardLib/year_mask_%s.jpg' % pixel_x, year_mask_pic)
        cv2.imwrite('labourer/idcardLib/month_mask_%s.jpg' % pixel_x, month_mask_pic)
        cv2.imwrite('labourer/idcardLib/day_mask_%s.jpg' % pixel_x, day_mask_pic)
        cv2.imwrite('labourer/idcardLib/address_mask_%s.jpg' %pixel_x, address_mask_pic)
        cv2.imwrite('labourer/idcardLib/idnum_mask_%s.jpg' %pixel_x, idnum_mask_pic)
...
def find_name(crop_gray, crop_org):
        template = cv2.UMat(cv2.imread('labourer/idcardLib/name_mask_%s.jpg'%pixel_x, 0))
        # showimg(crop_org)
...
def find_sex(crop_gray, crop_org):
        template = cv2.UMat(cv2.imread('labourer/idcardLib/sex_mask_%s.jpg'%pixel_x, 0))
        # showimg(template)
        w, h = cv2.UMat.get(template).shape[::-1]
        res = cv2.matchTemplate(crop_gray, template, cv2.TM_CCOEFF_NORMED)
        min_val, max_val, min_loc, max_loc = cv2.minMaxLoc(res)
...
def find_nation(crop_gray, crop_org):
        template = cv2.UMat(cv2.imread('labourer/idcardLib/nation_mask_%s.jpg'%pixel_x, 0))
        #showimg(template)
        w, h = cv2.UMat.get(template).shape[::-1]
        res = cv2.matchTemplate(crop_gray, template, cv2.TM_CCOEFF_NORMED)
        min_val, max_val, min_loc, max_loc = cv2.minMaxLoc(res)
...
#         template = cv2.UMat(cv2.imread('labourer/idcardLib/birth_mask_%s.jpg'%pixel_x, 0))
#         # showimg(template)
#         w, h = cv2.UMat.get(template).shape[::-1]
#         res = cv2.matchTemplate(crop_gray, template, cv2.TM_CCOEFF_NORMED)
#         #showimg(crop_gray)
...
def find_address(crop_gray, crop_org):
        template = cv2.UMat(cv2.imread('labourer/idcardLib/address_mask_%s.jpg'%pixel_x, 0))
        # showimg(template)
        #showimg(crop_gray)
        w, h = cv2.UMat.get(template).shape[::-1]
...
def find_idnum(crop_gray, crop_org):
        template = cv2.UMat(cv2.imread('labourer/idcardLib/idnum_mask_%s.jpg'%pixel_x, 0))
        # showimg(template)
        #showimg(crop_gray)
        w, h = cv2.UMat.get(template).shape[::-1]
        res = cv2.matchTemplate(crop_gray, template, cv2.TM_CCOEFF_NORMED)
...
if __name__=="__main__":
    idocr = idcardocr(cv2.UMat(cv2.imread('testimages/9.jpg')))
    print(idocr)
    # for i in range(15):
